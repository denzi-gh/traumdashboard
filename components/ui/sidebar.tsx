...
>(({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
  ...
  if (isMobile) {
    return (
      ...
      >
        <div
          className="fixed inset-y-0 left-0 z-50 w-[--sidebar-width] bg-sidebar p-0 text-sidebar-foreground shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left duration-300"
          style={
            {
...
>(({ asChild = false, isActive = false, className, ...props }, ref) => {
  // Simplified version without Slot
  if (asChild) {
